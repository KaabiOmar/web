        ...
        <nav id="cssmenu">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="logo" >
                            <a href="acceuil.html"><img src="assets/img/aaa.jpg" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-12">
                        ...
                        <ul class="navbar-nav">
                            ...
                            -->
                            <li><a href="#">Nos vetements</a>
                                <ul>
                                    <li><a href="coach.html">homme</a></li>
                                    <li><a href="trainers-single.html">femme</a></li>
                                </ul>
                            </li>
                           
                           <li><a href="#">Autres articles Sprotifs</a>
                                <ul>
                                    <li><a href="yoga.html">materiels</a></li>
                                    <li><a href="crossfit.html">accessoires</a></li>
                                    <li><a href="cardio.html">autres</a></li>   
                                </ul>
                            </li>
